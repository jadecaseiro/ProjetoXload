...
public class ConsultaCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        painelClientes.setBorder(javax.swing.BorderFactory.createTitledBorder("Tela de Clientes"));
        ...
        painelClientesLayout.setHorizontalGroup(
            ...
            .addGroup(painelClientesLayout.createSequentialGroup()
                .addGroup(painelClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(painelClientesLayout.createSequentialGroup()
                        .addGap(44, 44, 44)
                        .addComponent(spClientes, javax.swing.GroupLayout.PREFERRED_SIZE, 341, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(painelClientesLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        painelClientesLayout.setVerticalGroup(
            ...
            .addGroup(painelClientesLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(spClientes, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27)
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
       ...
       RepositorioClienteConexao instancia = RepositorioClienteConexao.obterInstancia();
        try {
       ...
       for(int i = 0; i < lista.size(); i++){
           modelo.addRow(new Object[]{this.lista.get(i).getCpf(),this.lista.get(i).getNome(),this.lista.get(i).getEmail()});
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        AlterarCliente form = new AlterarCliente(this.lista.get(jTable1.getSelectedRow()));
        form.show();
    }//GEN-LAST:event_btnAlterarActionPerformed

    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        try {
            RepositorioClienteConexao.obterInstancia().remover(this.lista.get(jTable1.getSelectedRow()));
